...
curl -s http://localhost:8000/factorial/5 | jq
...
curl -s "http://localhost:8000/history?input_number=5" | jq
# Sample output: [
#   {
#     "id": 2,
#     "input_number": 5,
...
curl -s "http://localhost:8000/history?min_input=3" | jq
# Sample output: [
#   {
#     "id": 2,
#     "input_number": 5,
...
curl -s "http://localhost:8000/history?max_input=5" | jq
# Sample output: [
#   {
#     "id": 2,
#     "input_number": 5,
...
curl -s "http://localhost:8000/history?min_input=3&max_input=5" | jq
# Sample output: [
#   {
#     "id": 2,
#     "input_number": 5,
...
curl -s http://localhost:8000/factorial/-1 | jq
# Sample output: {
